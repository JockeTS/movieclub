    ...
    */
    ...
    protected function build_links_first_prev()
    {
        ...
        if($this->options['show_links_first_last'] == true)
        {
            ...
            elseif($this->current_page != 1)
            {
                ...
                $this->links_html .= '<li><a class="'.$this->options['class_live_links'].'" href="'.$this->build_link_url(1).$getparams.'">'.$this->options['text_first'].'</a></li>'.PHP_EOL;
            }
        ...
        if($this->options['show_links_prev_next'] == true)
        {
            ...
            elseif($this->current_page != 1)
            {
                ...
                $this->links_html .= '<li><a class="'.$this->options['class_live_links'].'" href="'.$this->build_link_url($this->current_page - 1).$getparams.'">'.$this->options['text_prev'].'</a></li>'.PHP_EOL;
            }
    ...
    protected function loop_through_links($start, $finish, $array_block_label = '')
    {
        ...
        while($counter <= $finish)
        {
            ...
            else
            {
                ...
                $this->links_html .= '<li><a href="'.$this->build_link_url($counter).$getparams.'" class="'.$this->get_current_or_normal_class($counter).'">'.$counter.'</a></li>'.PHP_EOL;
            }
    ...
    protected function build_links_next_last()
    {
        ...
        if($this->options['show_links_prev_next'] == true)
        {
            ...
            {
                $this->links_html .= '<li><a class="'.$this->options['class_live_links'].'" href="'.$this->build_link_url($this->current_page + 1).$getparams.'">'.$this->options['text_next'].'</a></li>'.PHP_EOL;
            }
        ...
        if($this->options['show_links_first_last'] == true)
        {
            ...
            elseif($this->current_page != $this->total_pages)
            {
                $this->links_html .= '<li><a class="'.$this->options['class_live_links'].'" href="'.$this->build_link_url($this->total_pages).$getparams.'">'.$this->options['text_last'].'</a></li>'.PHP_EOL;
            }
